...
public final class BossBosque extends Enemigo {
    ...
    public String estrategiaAtacar(ArrayList<Jugador> jugadores) {
        ...
        String msg = "";
        int danyo, total, danyoInfligido, curar = 0;
        ...
        switch (estadoCombate) {
            case 0:
                ...
                break;
            case 1:
                curar = (int) (this.getHpActual() + 300);
                if (curar > this.getHp()) {
                    msg = "La energía del bosque alimenta a Yggdrasil recuperando toda la HP";
                    this.setHpActual(this.getHp());
                } else {
                    msg = "La energía del bosque alimenta a Yggdrasil recuperando 300 PV";
                    this.setHpActual((int) (this.getHpActual() + 300));
                }
                break;
            case 2:
                for (int i = 0; i < jugadores.size(); i++) {
                    jugadores.get(i).setHpActual(jugadores.get(i).getHpActual() - 50);
                }
