...
public final class BaseDatosEnemigos{
    ...
    public void enemigosBosque() throws SlickException{
        ...
        gob11 = new Goblin(1, 110, 55, 40);
        gob12 = new Goblin(1, 110, 55, 40);
        gob13 = new Goblin(1, 110, 55, 40);
        gob31 = new Goblin(3, 150, 65, 50);
        gob32 = new Goblin(3, 150, 65, 50);
        gob33 = new Goblin(3, 150, 65, 50);
        gob51 = new Goblin(5, 200, 75, 60);
        gob52 = new Goblin(5, 200, 75, 60);
        gob53 = new Goblin(5, 200, 75, 60);
        sp11 = new Spider(1, 80, 45, 20);
        sp12 = new Spider(1, 80, 45, 20);
        sp13 = new Spider(1, 80, 45, 20);
        sp31 = new Spider(3, 100, 55, 30);
        sp32 = new Spider(3, 100, 55, 30);
        sp33 = new Spider(3, 100, 55, 30);
        sp51 = new Spider(5, 120, 70, 40);
        sp52 = new Spider(5, 120, 70, 40);
        sp53 = new Spider(5, 120, 70, 40);
    }
